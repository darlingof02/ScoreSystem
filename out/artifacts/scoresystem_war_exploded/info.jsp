    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            ...
            <ul class="list-unstyled">
                ...
                <li class="active"><a href="#" onclick="document.getElementById('infologin').submit();return false;"> <i class="icon-padnote"></i>Forms </a></li>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="passwordchange" method="post">
                                        <div class="form-group">
                                            ...
                                            <input  placeholder="account" class="form-control" name="account_student">
                                        </div>
                                        <div class="form-group">
