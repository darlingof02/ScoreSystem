    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            ...
            <ul class="list-unstyled">
                ...
                <li ><a href="studentmainpage.jsp" onclick="document.getElementById('rehome').submit();return false;"> <i class="icon-home"></i>Home </a></li>>
                <form action = "StudentLesson" method="post" id="myLesson">
                    <input type="hidden" name="account_student" value="${account_student}">
                    <input type="hidden" name="password" value="${password}">
                </form>
                <li class="active"><a href="#" onclick="document.getElementById('myLesson').submit();return false;"><%--<a href="#" onclick="document.getElementById('myLesson').submit();return false;"> --%><i class="icon-grid"></i>Tables </a></li>
        ...
        <div class="content-inner">
            ...
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">信息查询	</h2>
                </div>
            </header>
            <!-- Breadcrumb-->
            <div class="breadcrumb-holder container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">信息查询            </li>
                </ul>
            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <c:forEach items="${myScore}" var="list" varStatus="loop">
                                                ...
                                                <td ><button type="button" class="btn btn-info" data-toggle="modal"  data-target="#addUserModal" onclick="get_modal_info('${list.getLesson_code()}','${list.getStudent_ID()}')">编辑</button>
                                                    &nbsp;&nbsp;</td>
                                                </tbody>
